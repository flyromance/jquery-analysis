...
*/
  ...
  (function($) {
	  ...
	  $.VJ_stayCenter = function(obj, padding, m_left, m_top){
		  ...
		  var $obj = $(obj);
		  var o_l = $.VJ_getWin().w/2 - m_left - padding + $.VJ_getWin().l,
			  o_h = $.VJ_getWin().h/2 - m_top  - padding + $.VJ_getWin().t;
		  ...
		  $(clicked_obj).click(function(){
			  ...
			  $(window).resize(function(){
				  if($show_obj.css("display")!=="none"){
					  $.VJ_stayCenter(show_obj,so_padding,m_left,m_top);
					  $black_modalback.css({"height":$.VJ_getBH()});
				  }
			  });
		  })
	  ...
	  $.fn.VJ_slidePics = function(li_default_class, li_active_class, arrow_left, arrow_right, isAutoplay, style){
		  ...
		  var isAuto = isAutoplay === !1 ? isAutoplay : true,
			  isArrow = !1,
			  isScroll= !1;
		  ...
		  $("li:gt(0)",this).on("mouseover",function(){addHover($(this));})
			  .on("mouseleave",function(){removeHover($(this));})   //初始化绑定li的hover效果（激活状态的li不绑定）
