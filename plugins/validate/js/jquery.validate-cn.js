...
(function($) {
	...
	$.extend($.validator, {
		...
		methods: {
			...
			/*add by yanghongwei 2013.7.10 start*/
			// 字符验证       
			...
			isMobile:function(value, element) {
				return this.optional(element) || (value.length == 11 && /^13[0-9]{1}[0-9]{8}$|15[012356789]{1}[0-9]{8}$|18[012356789]{1}[0-9]{8}$|14[57]{1}[0-9]{8}$/.test(value));
			},
			...
			/*add by yanghongwei 2013.7.10 end*/
		}
